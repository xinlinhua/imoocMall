     ...
     <nav-bread><span>Address</span>  </nav-bread>
        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="next-btn-wrap">
              <router-link class="btn btn--m btn--red" href="#" :to="{path:'/orderConfirm',query:{addressId: selectAddressId}}">Next</router-link>
            </div>
          </div>
        </div>
      </div>
      <Modal :mdShow="isMdShow" v-on:close="closeModal">
        ...
        <div slot="btnGroup">
          ...
          <a href="javascript:;" @click="delAddress" class="btn btn--m">确定</a>
          ...
          getAddressList(){
            axios.get('/users/addressList').then((resp)=>{
              if(resp.data.resultCode === '0'){
                ...
                this.selectAddressId = this.addressList[0].addressId;
