    ...
    <div>
        ...
        <div class="navbar">
          ...
          <div class="navbar-right-container" style="display: flex;">
            ...
            <div class="md-modal md-msg md-modal-transition md-show" v-show="showLogin">
                ...
                <div class="md-content">
                  <div class="confirm-tips">
                      <div class="error-wrap">
                          <span class="error error-show" v-show="errorTips">用户名或密码错误</span>
                      </div>
                      <ul> 
            ...
            <div class="md-overlay" v-show="showLogin"></div>
          </div>
        </div>
      </header>
    </div>
